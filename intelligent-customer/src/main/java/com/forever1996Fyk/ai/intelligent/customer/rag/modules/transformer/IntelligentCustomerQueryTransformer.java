package com.forever1996Fyk.ai.intelligent.customer.rag.modules.transformer;
 ...
 */
@Slf4j
public class IntelligentCustomerQueryTransformer implements QueryTransformer {
    ...
    public IntelligentCustomerQueryTransformer(ChatModel chatModel, String chatMessageId) {
        this(chatModel, LG_AGENT_PROMPT, chatMessageId, null);
    }

    public IntelligentCustomerQueryTransformer(ChatModel chatModel, String chatMessageId, Consumer<String> progressCallback) {
        this(chatModel, LG_AGENT_PROMPT, chatMessageId, progressCallback);
    }

    public IntelligentCustomerQueryTransformer(ChatModel chatModel, PromptTemplate promptTemplate, String chatMessageId, Consumer<String> progressCallback) {
    ...
    private String format(List<ChatMessage> chatMemory) {
