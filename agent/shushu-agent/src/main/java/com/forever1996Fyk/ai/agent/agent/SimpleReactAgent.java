        ...
        try {
            ...
            for (JsonNode item : results) {
                ...
                if (url != null && !url.isBlank()) {
                    state.getSearchResults().add(new SearchResult(url, title, content));
                }
            }
        } catch (Exception e) {
        ...
        while (true) {
            ...
            if (maxRounds > 0 && round > maxRounds) {
                ...
                return SimpleReactResult.builder()
                        .answer(forcedAnswer)
                        .searchResults(agentState != null ? agentState.getSearchResults() : Collections.emptyList())
                        .build();
            }
            ...
            if (!chatResponse.chatResponse().hasToolCalls()) {
                ...
                return SimpleReactResult.builder()
                        ...
                        .searchResults(agentState.getSearchResults())
                        .build();
            }
