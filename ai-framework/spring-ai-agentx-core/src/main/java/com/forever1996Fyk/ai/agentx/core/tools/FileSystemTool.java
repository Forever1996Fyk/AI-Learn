package com.forever1996Fyk.ai.agentx.core.tools;
 ...
 * @program: AI-Learn
 * @description:
 * FileSystemTool - File system tools for Spring AI
 *
...
public class FileSystemTool {
     ...
     * @deprecated 用 {@link #FileSystemTool(List, boolean, int)} 或 {@link Builder#allowedDirs(String...)}，
     * 单目录等价于 allowedDirs([rootDir])。
     */
    @Deprecated
    public FileSystemTool(String rootDir, boolean virtualMode, int maxFileSizeMb) {
     ...
     * @param maxFileSizeMb 读取操作的最大文件大小（MB）
     */
    public FileSystemTool(List<String> allowedDirs, boolean virtualMode, int maxFileSizeMb) {
        ...
        logger.debug("FileSystemTool initialized: cwd={}, allowedRoots={}, virtualMode={}, maxFileSize={}MB",
    ...
    public static ToolCallback[] create() {
        return ToolCallbacks.from(new FileSystemTool());
    }
     ...
     * <pre>{@code
     * // 限定单个目录
     * FileSystemTool.create("/data/project")
     *
     * // 限定多个目录
     * FileSystemTool.create("/data/project", "/tmp/output")
     * }</pre>
     *
    ...
    public static ToolCallback[] create(String... allowedDirs) {
        ...
        return ToolCallbacks.from(new FileSystemTool(Arrays.asList(allowedDirs), false, DEFAULT_MAX_FILE_SIZE_MB));
    }
    ...
    public static class Builder {
        ...
        /**
         * 构建 FileSystemTool 实例。
         *
         * @return FileSystemTool 实例
         */
        public FileSystemTool build() {
            return new FileSystemTool(allowedDirs, virtualMode, maxFileSizeMb);
        }
    }
