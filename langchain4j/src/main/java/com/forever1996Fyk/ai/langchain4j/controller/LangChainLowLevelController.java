...
public class LangChainLowLevelController {
    ...
    public Flux<String> streamTest(HttpServletResponse response) {
        ...
        Flux<String> flux = Flux.create(fluxSink -> {
            streamingChatModel.chat("你好，给我推荐几本 Java 书籍", new StreamingChatResponseHandler() {
    ...
    public String memory(HttpServletResponse response) {
        ...
        messages.add(UserMessage.userMessage("我叫YK，是一个程序员"));
        ...
        //第二轮对话
        messages.add(UserMessage.userMessage("YK是干什么的?"));
    ...
    public String memory1(HttpServletResponse response) {
        ...
        //第一轮对话
        chatMemory.add(SystemMessage.systemMessage("你是一个AI助手"));
        chatMemory.add(UserMessage.userMessage("我叫YK，是一个程序员"));
        ...
        //第二轮对话
        chatMemory.add(UserMessage.userMessage("YK是干什么的?"));
        ...
        //第三轮对话
        chatMemory.add(UserMessage.userMessage("我是谁？"));
    ...
    public String structure() {
        ResponseFormat responseFormat = ResponseFormat.builder()
                .type(ResponseFormatType.JSON) // 类型可以是 TEXT（默认）或 JSON
    ...
    public String tool() {
        ...
        //2.构造用户提示词
        UserMessage userMessage = UserMessage.from("2026年5月21日，合肥的气温怎样？");
