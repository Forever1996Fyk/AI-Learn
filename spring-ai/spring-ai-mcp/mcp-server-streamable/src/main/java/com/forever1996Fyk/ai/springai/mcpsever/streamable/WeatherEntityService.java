...
import com.forever1996Fyk.ai.springai.mcpsever.streamable.entity.GetWeatherRequest;
...
public class WeatherEntityService {
    ...
    private static final Logger log = LoggerFactory.getLogger(WeatherEntityService.class);
     ...
     */
    @Tool(name = "get_weather_by_request", description = "获取指定城市的当前天气情况，格式化后的天气报告字符串")
    public String getWeather(GetWeatherRequest request) {
